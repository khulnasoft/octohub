    ...
    <div>
      <div className="hidden sm:block">
        <FeatureBlock
          image={{
            position: 'full',
            src: '/static/screenshots/dark/octohub-desktop-menubar.jpg',
            aspectRatio: 1440 / 900,
            alt:
              'OctoHub - Desktop app with Menubar mode, and a Push Notification at the top right',
          }}
      ...
      <FeatureBlock
        image={{
          position: 'full',
          src: '/static/screenshots/dark/octohub-desktop-labels.jpg',
          aspectRatio: 1440 / 798,
          alt: 'OctoHub - Label filter',
        }}
      ...
      <FeatureBlock
        image={{
          position: 'full',
          src: '/static/screenshots/dark/octohub-desktop-users.jpg',
          aspectRatio: 1440 / 798,
          alt: 'OctoHub - 4 columns with user activities',
        }}
      ...
      <FeatureBlock
        image={{
          position: 'full',
          src: '/static/screenshots/dark/octohub-cross-platform.jpg',
          aspectRatio: 1440 / 900,
          alt:
            'OctoHub - Desktop app with Menubar mode, and a Push Notification at the top right',
        }}
      ...
      >
        <CheckLabels center>
          <a
            href="https://itunes.apple.com/us/app/octohub-for-github/id1191864199?l=en&mt=8&utm_source=octohub_landing_page"
            target="_blank"
          ...
          <a
            href="https://play.google.com/store/apps/details?id=com.khulnasoft&utm_source=octohub_landing_page"
            target="_blank"
            rel="noopener noreferrer"
          >
