import { PlatformCategory } from '@octohub/core'
      ...
      <section id="download" className="container">
        ...
        <div className="flex flex-col items-center m-auto text-center">
          ...
          {category === 'desktop' && (
            <>
              <p className={swClasses.description}>
                Download OctoHub desktop app for a more complete experience with
              ...
              <div className={swClasses.buttonsContainer}>
                <Button
                  ...
                  download
                  href={`https://github.com/khulnasoft/octohub/releases/download/v${version}/OctoHub-${version}.dmg`}
                >
                  Download for macOS
                </Button>
                ...
                <Button
                  ...
                  className={swClasses.button}
                  download
                  href={`https://github.com/khulnasoft/octohub/releases/download/v${version}/OctoHub-Setup-${version}.exe`}
                >
                ...
                <Button
                  ...
                  className={swClasses.button}
                  download
                  href={`https://github.com/khulnasoft/octohub/releases/download/v${version}/OctoHub-${version}.AppImage`}
                >
                  Download for Linux
                </Button>
              </div>
          ...
          {category === 'mobile' && (
            <>
              <p className={swClasses.description}>
                Download OctoHub mobile app to get the native experience on your
              ...
              <div className={swClasses.buttonsContainer}>
                <Button
                  ...
                  className={swClasses.button}
                  href="https://itunes.apple.com/us/app/octohub-for-github/id1191864199?l=en&mt=8&utm_source=octohub_landing_download"
                ...
                <Button
                  ...
                  className={swClasses.button}
                  href="https://play.google.com/store/apps/details?id=com.khulnasoft&utm_source=octohub_landing_download"
                  target={category === 'mobile' ? '_top' : '_blank'}
                >
          ...
          {category === 'web' && (
            <>
              <p className={swClasses.description}>
                We recommend downloading OctoHub apps to get the full experience,
