      ...
      <section id="homepage">
        ...
        <div className="container flex flex-col lg:flex-row">
          <div className="mb-12 lg:mb-0">
            ...
            <ResponsiveImage
              alt="OctoHub Screenshot with 4 columns: Notifications, Facebook activity, TailwindCSS activity and Filters"
              src="/static/screenshots/dark/octohub-desktop.jpg"
