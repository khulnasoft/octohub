import { constants, isPlanStatusValid } from '@octohub/core'
          ...
          <SubHeader title="Community">
            ...
            <View style={sharedStyles.horizontal}>
              <Link
                ...
                href={constants.OCTOHUB_LINKS.TWITTER_PROFILE}
                openOnNewTab
                textProps={{
                  color: 'foregroundColor',
                  style: {
              ...
              <Link
                ...
                enableForegroundHover
                href={constants.OCTOHUB_LINKS.SLACK_INVITATION}
                openOnNewTab
                textProps={{
                  color: 'foregroundColor',
                  style: {
              ...
              */}
              ...
              <Link
                ...
                enableForegroundHover
                href={constants.OCTOHUB_LINKS.GITHUB_REPOSITORY}
                openOnNewTab
                textProps={{
                  color: 'foregroundColor',
                  style: {
