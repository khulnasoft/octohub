...
const logo = require('@octohub/web/public/static/media/logo.png') // eslint-disable-line
    ...
    >
      <View style={[sharedStyles.fullWidth, sharedStyles.padding]}>
        ...
        >
          ...
          >
            {plan && plan.amount
              ? 'You can now use OctoHub with the unlocked features.'
