...
import { getDefaultOctoHubHeaders } from '../../../utils/api'
...
const poweredByStripeDarkBanner =
  require('@octohub/web/public/static/media/stripe/powered_by_stripe_outline_dark.png').default // eslint-disable-line
const poweredByStripeLightBanner =
  require('@octohub/web/public/static/media/stripe/powered_by_stripe_outline_light.png').default // eslint-disable-line
    ...
    async function cancelSubscription() {
      ...
      try {
        ...
        const response = await axios.post(
          ...
          { headers: getDefaultOctoHubHeaders({ appToken }) },
        )
              ...
              <>
                ...
                >
                  <ThemedTextInput
                    ...
                    placeholder="Let us know your main use case so we can make OctoHub even better for you."
          ...
          <>
            ...
            >
              ...
              <Checkbox
                ...
                label="I plan to keep using OctoHub"
                ...
                <>
                  {freePlan && !freePlan.trialPeriodDays ? (
                    <ThemedText color="foregroundColorMuted65">
                      OctoHub is made by a single person working on it full time.
                      It needs to be a sustainable project to exist.
                      {'\n\n'}
                      If you want OctoHub to keep existing and being updated,
                      consider supporting it with a paid plan.
                    </ThemedText>
                  ) : (
                    <ThemedText color="foregroundColorMuted65">
                      {
                        "OctoHub doesn't have a free plan anymore. The only way to keep using OctoHub is by having a paid subscription. After cancelling, you can keep using it for the already paid period."
                      }
                    </ThemedText>
                  )}
