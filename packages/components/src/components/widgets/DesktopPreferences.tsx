...
export const DesktopPreferences = React.memo(() => {
  ...
  const DownloadConfirmationHandler = () => {
    Dialog.show(
      ...
      'This option is only available for the Desktop App. Download it at khulnasoft.com to have access to it.',
      [
        {
          text: 'Download',
          onPress: () => {
            Browser.openURLOnNewTab(constants.OCTOHUB_LINKS.DOWNLOAD_PAGE)
          },
          style: 'default',
        },
        {
        ...
        {!Platform.isElectron && (
          <>
            ...
            <ButtonLink
              ...
              href={constants.OCTOHUB_LINKS.DOWNLOAD_PAGE}
              openOnNewTab
              size={32 * scaleFactor}
            >
