...
import { Analytics, OctoHubAnalyticsCustomDimensions } from './'
...
} as Record<keyof OctoHubAnalyticsCustomDimensions, string>
...
ga('set', 'appName', __DEV__ ? 'octohub-dev' : 'octohub')
