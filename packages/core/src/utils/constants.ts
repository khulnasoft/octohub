...
export const GOOGLEPLAY_ID = 'com.khulnasoft'

export const APP_BASE_URL = 'https://app.khulnasoft.com'
export const OCTOHUB_BETA_URL = 'https://beta.khulnasoft.com'
export const API_BASE_URL = 'https://api.khulnasoft.com'
export const GRAPHQL_ENDPOINT = `${API_BASE_URL}/graphql`

const LANDING_BASE_URL = 'https://khulnasoft.com'
export const OCTOHUB_LINKS = {
  ...
  SLACK_INVITATION: 'https://slack.khulnasoft.com',
  GITHUB_REPOSITORY: 'https://github.com/khulnasoft/octohub',
  TWITTER_PROFILE: 'https://twitter.com/octohub_app',
}

export const APP_DEEP_LINK_SCHEMA = 'octohub'
