...
if (!process.version) {
  process.version = require('@octohub/core/src/utils/constants').APP_VERSION
}

const { App } = require('@octohub/components/src/components/App')

AppRegistry.registerComponent('octohub', () => App)
